...
syn keyword modelicaStatement if import in initial inner input initialState isMayer isLagrange isConstraint isFinalConstraint
...
syn keyword modelicaStatement package parameter partial partial pre previous protected public
syn keyword modelicaStatement record redeclare replaceable return
syn keyword modelicaStatement sample size smooth start
syn keyword modelicaStatement terminal then type transition
